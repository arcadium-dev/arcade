...
func TestListPlayers(t *testing.T) {
	...
	t.Run("create request failure", func(t *testing.T) {
		...
		_, err := c.ListPlayers(ctx, assets.PlayerFilter{})
	...
	t.Run("success", func(t *testing.T) {
		...
		aPlayers := []*assets.Player{
			{
				ID:          assets.PlayerID(u),
				Name:        name,
				Description: desc,
				HomeID:      assets.RoomID(u),
...
func TestGetPlayer(t *testing.T) {
	var (
		ctx = context.Background()
		id  = assets.PlayerID(uuid.MustParse("4efee5c1-01ac-41c6-a479-0ae59617482b"))
	)
	...
	t.Run("success", func(t *testing.T) {
		...
		player, err := c.GetPlayer(ctx, assets.PlayerID(u))
...
func TestCreatePlayer(t *testing.T) {
	...
	var (
		ctx        = context.Background()
		homeID     = assets.RoomID(uuid.MustParse(home))
	...
	t.Run("player change failure", func(t *testing.T) {
		...
		_, err := c.CreatePlayer(ctx, assets.PlayerCreate{PlayerChange: assets.PlayerChange{Name: ""}})
	...
	t.Run("create request failure", func(t *testing.T) {
		...
		_, err := c.CreatePlayer(ctx, assets.PlayerCreate{
	...
	t.Run("success", func(t *testing.T) {
		...
		var (
			playerID = assets.PlayerID(uuid.MustParse(id))
			created  = assets.Timestamp{Time: time.Now().UTC()}
			updated  = assets.Timestamp{Time: time.Now().UTC()}
		)
		...
		player, err := c.CreatePlayer(ctx, assets.PlayerCreate{
			PlayerChange: assets.PlayerChange{
				Name:        name,
				Description: desc,
				HomeID:      homeID,
...
func TestUpdatePlayer(t *testing.T) {
	...
	t.Run("player change failure", func(t *testing.T) {
		...
		_, err := c.UpdatePlayer(ctx, id, assets.PlayerUpdate{PlayerChange: assets.PlayerChange{
			Name: name,
		}})
	...
	t.Run("update request failure", func(t *testing.T) {
		...
		_, err := c.UpdatePlayer(ctx, id, assets.PlayerUpdate{
			PlayerChange: assets.PlayerChange{
				Name:        name,
				Description: desc,
				HomeID:      homeID,
	...
	t.Run("success", func(t *testing.T) {
		...
		player, err := c.UpdatePlayer(ctx, playerID, assets.PlayerUpdate{
			PlayerChange: assets.PlayerChange{
				Name:        name,
				Description: desc,
				HomeID:      homeID,
