...
func TestPlayerStorageList(t *testing.T) {
	const (
...
func TestPlayerStorageGet(t *testing.T) {
	const (
...
func TestPlayerStorageCreate(t *testing.T) {
	const (
...
func TestPlayerStorageUpdate(t *testing.T) {
	const (
...
func TestPlayerStorageRemove(t *testing.T) {
	const (
