...
type (
	...
	service interface {
		list(ctx context.Context) ([]arcade.Room, error)
		get(ctx context.Context, roomID string) (arcade.Room, error)
		create(ctx context.Context, p roomRequest) (arcade.Room, error)
		update(ctx context.Context, roomID string, p roomRequest) (arcade.Room, error)
...
func (h handler) list(w http.ResponseWriter, r *http.Request) {
	...
	err = json.NewEncoder(w).Encode(newRoomsResponse(p))
	if err != nil {
...
func (h handler) get(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	err = json.NewEncoder(w).Encode(newRoomResponse(p))
	if err != nil {
		chttp.Response(ctx, w, fmt.Errorf(
...
func (h handler) update(w http.ResponseWriter, r *http.Request) {
	...
	p, err := h.s.update(ctx, roomID, req)
	if err != nil {
		chttp.Response(ctx, w, err)
		return
	}
