...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/v1/user", wrapper.List).Methods(http.MethodGet)

	r.HandleFunc(options.BaseURL+"/v1/user", wrapper.Create).Methods(http.MethodPost)

	r.HandleFunc(options.BaseURL+"/v1/user/{id}", wrapper.Remove).Methods(http.MethodDelete)

	r.HandleFunc(options.BaseURL+"/v1/user/{id}", wrapper.Get).Methods(http.MethodGet)

	r.HandleFunc(options.BaseURL+"/v1/user/{id}", wrapper.AssociatePlayer).Methods(http.MethodPatch)

	r.HandleFunc(options.BaseURL+"/v1/user/{id}", wrapper.Update).Methods(http.MethodPut)
