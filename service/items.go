...
func (s Items) Register(router *mux.Router) {
...
func (s Items) List(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (s Items) Create(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (s Items) Update(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (s Items) Remove(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
