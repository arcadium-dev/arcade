# Players: create, get and remove
#   - Creates a player
#   - Gets the player
#   - Checks that the returned name, description, home and location
#   - Remove the player
test_players_create_get_delete() {
  title "Players: create, get and delete"
